...
export default function FloatingWhatsApp() {
  ...
  return (
    <a href="https://wa.me/923054573962" target="_blank" rel="noopener noreferrer"
      className={"fixed bottom-6 right-6 z-50 w-14 h-14 rounded-full flex items-center justify-center transition-all duration-700 cursor-none group " + (show ? "opacity-100 scale-100" : "opacity-0 scale-75 pointer-events-none")}
      style={{ background: "linear-gradient(135deg, #25D366, #128C7E)" }} aria-label="Chat on WhatsApp">
